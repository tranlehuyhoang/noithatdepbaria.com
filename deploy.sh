...
PROJECT_DIR="/var/www/noithatdepbaria.com"
GIT_REPO="https://github.com/${USERNAME}/noithatdepbaria.com.git"
SQL_FILE="${PROJECT_DIR}/noithatdepbaria.sql"
DB_NAME="noithatdepbaria"
DB_USER="noithatdepbaria"
DB_PASSWORD="noithatdepbarianoithatdepbaria"  # Thay đổi mật khẩu nếu cần
