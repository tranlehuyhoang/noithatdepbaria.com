            ...
            <body>
                ...
                <div class="blog_wrapper layout-blog" itemscope itemtype="https://schema.org/Blog">
                    ...
                    <meta itemprop="description"
                        content="Giao diện OH! Decor phù hợp với các doanh nghiệp, cửa hàng đang kinh doanh sản phẩm decor, nội ngoại thất, đồ trang trí, tranh ảnh, thiết kế và nhiều Tin tức khác">
                    <div class="container">
                        <div class="row">
                            <div class="right-content col-lg-9 col-12 order-lg-2 mb-5 mb-lg-0">
                                <h1 class="title-page bold text-uppercase mb-3">Tin tức</h1>
