        ...
        <div>
            ...
            <head>
                ...
                <link
                    ...
                    rel="stylesheet" type="text/css" media="all" />
                <link href="/assets/100/501/740/themes/929449/assets/style_page.scss.css?1736415638335"
                    rel="stylesheet" type="text/css" media="all" />
                <link href="/assets/100/501/740/themes/929449/assets/contact_style.scss.css?1736415638335"
                    rel="stylesheet" type="text/css" media="all" />
                <style>
                    :root {
                        font-size: 16px;
                ...
                <div class="layout-contact">
                    ...
                    <div class="info-contact container mb-5">
                        <div class="row m-0 border">
                            ...
                            <div class="contact col-lg-5 col-md-6">
                                <h2 class="title bold mb-md-4 mb-2 bold">Thông tin liên hệ</h2>
                                ...
                                <div class="item position-relative mb-3">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
                                        ...
                                        class="position-absolute svg-inline--fa fa-envelope fa-w-16">
                                        <path fill="currentColor"
                                ...
                                <div class="item position-relative mb-3">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                        ...
                                        viewBox="0 0 512 512"
                                        class="position-absolute svg-inline--fa fa-phone-alt fa-w-16">
                                        <path fill="currentColor"
                                ...
                                <div class="item position-relative">
                                    ...
                                    T2 - T6: 8 AM - 5 PM<br />-T7 - CN: 8 AM - 2 PM
                                </div>
                            </div>
                        </div>
                    </div>
