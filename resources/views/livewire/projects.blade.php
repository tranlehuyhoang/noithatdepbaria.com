        ...
        <div>
            ...
            <head>
                ...
                <link
                    ...
                    rel="stylesheet" type="text/css" media="all" />
                <link
                    href="/assets/100/501/740/themes/929449/assets/blog_article_style.scss.css?1736415638335"
                    rel="stylesheet" type="text/css" media="all" />
            ...
            <body>
                ...
                <div class="blog_wrapper layout-blog" itemscope itemtype="https://schema.org/Blog">
                    ...
                    <meta itemprop="description"
                        content="Giao diện OH! Decor phù hợp với các doanh nghiệp, cửa hàng đang kinh doanh sản phẩm decor, nội ngoại thất, đồ trang trí, tranh ảnh, thiết kế và nhiều dịch vụ khác">
                    <div class="container">
                        {{-- <ul class="cate-project d-flex p-0 m-0 list-unstyled mb-5">
                            <li class="rounded-5 active"><a href="/du-an">Tất cả</a></li>
                            <li class="rounded-5"><a href="/du-an/chung-cu">Chung cư </a></li>
                            <li class="rounded-5"><a href="/du-an/nha-dat">Nhà đất </a></li>
                            <li class="rounded-5"><a href="/du-an/biet-thu">Biệt thự </a></li>
                        </ul> --}}
                        <h1 class="title-page bold text-uppercase mb-3 d-none">Dự án</h1>
                ...
                {{-- <div class="project-popup position-fixed">
                    <span class="close-popup"></span>
                    <div class="content"></div>
                </div> --}}
                {{-- <script>
                    $('.item-blog-project a').click(function() {
                        var url = $(this).attr('href');
                        var selector = ".project-popup .content";
                        ...
                        setTimeout(function() {
                            ...
                            $('.project-popup .content').addClass('fadeinup');
                        }, 1000)
                        return false
                    })
                    $('.project-popup .close-popup').click(function() {
                        $('body').removeClass('no-scroll');
                        $('.close-popup').removeClass('active');
                        $('.overlay-dark').removeClass('active');
                        $('.project-popup').removeClass('active');
                        $('.project-popup .content').removeClass('fadeinup');
                    })

                    function getContent(url, selector) {
                        url = url + "?view=project";
                        $.ajax({
                            type: 'GET',
                            url: url,
                            dataType: "html",
