            ...
            <div class="col-12 col-md-6 col-lg-3 col-footer col-info mb-4 mb-md-5">
                ...
                <p class="info-icon mb-1 position-relative pl-4"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            ...
                            fill="#FFF" />
                    </svg>Tổ 10, xã Hòa Đông, tp Bà rịa, Vũng Tàu</p>
                <p class="info-icon mb-1 position-relative pl-4">
                    ...
                    <a href="tel:0937313731" class="phone info-icon d-block mb-1"
                        title="0937.31.37.31">0937.31.37.31</a>
                </p>
                <p class="info-icon mb-1 position-relative pl-4">
                    ...
                    <a href="mailto:lenhatanhfpt123@gmail.com" class="email info-icon d-block"
